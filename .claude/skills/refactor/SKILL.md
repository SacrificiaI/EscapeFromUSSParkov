...
- [.claude/rules/priorities.md](../../rules/priorities.md) — the tiebreaker
  order (correctness, simplicity, pedagogical clarity, readability,
  performance).
- [.claude/rules/doctrine.md](../../rules/doctrine.md) — what performance
  doctrine applies, and what explicitly doesn't (no multiplayer/Fix64/
  lockstep concerns in this project).
- [.claude/rules/godot-csharp-conventions.md](../../rules/godot-csharp-conventions.md)
...
- [.claude/knowledge/gaming-patterns-index.md](../../knowledge/gaming-patterns-index.md)
