...
(commit-message prefixes, the `.Codex/handoff.md` format shared with
`/wrap-up`); travels with the rest of `.Codex/`, not standalone.
...
2. **Brief handoff note** — write `.Codex/handoff.md` so a resumed session
...
4. **Write the handoff note** — `.Codex/handoff.md`, same format as
...
Codex: 2 files modified.
  ...
  Handoff updated (.Codex/handoff.md):
  ## Completed
